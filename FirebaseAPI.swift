...
//------------- STRUCTS -------------
    ...
    struct User {
        ...
        init(id: String, type: String, first: String, last: String, email :String, job: String, company: String, location: String, questionAnswers: [String: Int]) {
            self.id = id
            self.type = type
...
//---------------- USERS ------------------
    ...
    func getMentors(callback: @escaping () -> ()) {
        var users : [User] = []
        ...
        //ref.observe(.childAdded, with: { snapshot in
           // if let snapshotValue = snapshot.value as? [String: Any],
            //    let currentData = snapshotValue["users"] as? [String:Any] {
                ...
                return User(id: "", type: type, first: firstname, last: lastname, email: email, job: job, company: company, location: location, questionAnswers: questionAnswers)
            //}
    }
